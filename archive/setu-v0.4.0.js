( /* eslint-disable complexity */ /* eslint-disable max-statements */ /* eslint-disable no-shadow-restricted-names */
  function(ns, undefined) {
    ...
    function instances__init(instance, data) {
      if (data) {
    ...
    function __res__fetchOrGet(resource, onsuccess) {
      switch (resource.type) {
        case KW_LIST:
          ...
          break
        case KW_DETAIL:
          __res__getDetail(resource, onsuccess)
          break
        case KW_API:
    ...
    function __res__getDetail(resource, onsuccess) {
      if (resource.value) {
        onsuccess(__res__repr(resource))
      } else {
        if (!__res__hasFetchQueue(resource)) {
    ...
    function res__registerDetail(instance, imeta) {
      ...
      /*else {
         GResources[imeta.$k].value = instance
         console.info('Setu.resources ~ {}', instance)
       }*/
    }
      ...
      if (!list.registered) {
        ...
        if (list.params) {
          ...
          for (var fk in paramsFks) {
            ...
            events__registerFrom(ns.EVENT_INSTANCE_CHANGE, fkModel, __lists__onFilterInstanceChange, list)
            events__registerFrom(ns.EVENT_INSTANCE_DELETE, fkModel, __lists__onFilterInstanceDelete, list)
          }
        }
    ...
    function __parser__$() {
      if (!observer__running() && parser__isDone()) {
        parser__endgame()
      }
    }
    ...
    events__register(ns.EVENT_LIST_RESOURCE_CREATE, __binds__onListCreate, ns)
...
$_.ready(function() {
  Setu.adapters['Django'] = [{
    ...
    handler: function(ignore, xhr, options, context) {
      if (!/^(http__get|HEAD|OPTIONS|TRACE)$/.test(options.method) && !
        context.crossDomain) {
